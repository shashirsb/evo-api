...
public JsonObject updateUser(JsonObject jsonObject) {
    ...
    try {
            ...
            if (resultDoc != null) {
                ...
                .add("data", JSON.createObjectBuilder()
                                    .add( "userid", jsonObject.get("userid"))
                                    .add( "firstname",  jsonObject.isNull("firstname") ? null : jsonObject.get("firstname"))
                                    .add( "lastname",  jsonObject.isNull("lastname") ? null : jsonObject.get("lastname"))
                                    .add( "customertype",  jsonObject.isNull("customertype") ? null : jsonObject.get("customertype"))
                                    .add( "mobile",  jsonObject.isNull("mobile") ? null : jsonObject.get("mobile"))
                                    .add( "address",  jsonObject.isNull("address") ? null : jsonObject.get("address"))
                                    .add( "evinfo", JSON.createObjectBuilder()
